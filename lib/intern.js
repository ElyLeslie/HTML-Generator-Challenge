...
class Intern{
    ...
    managerQuestions() {
        ...
        .then((answers) => {
            const managerInfo = `<!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="card col d-flex justify-content-center" style="width: 18rem; background-color: black; text-align: center; margin: 0 auto; float: none; margin-bottom: 10px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 25px; font-weight: bold; color: white;"> Name: ${answers.teamManager}
                        </h5>
            ...
            fs.appendFile('newHTML.html', managerInfo, err => err ? console.log(err) : console.log("Sucessful"))
        })
        }
}
